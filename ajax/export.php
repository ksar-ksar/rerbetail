...
if ($type == 'prevus'){
	...
	$sql .= "	WHEN stop = 473364 THEN 'Aéroport CDG 2 TGV'";
	$sql .= "	WHEN stop = 43186 THEN 'Robinson'";
	$sql .= "	WHEN stop = 43086 THEN 'Orsay-Ville'";
	$sql .= "	WHEN stop = 43145 THEN 'La Plaine-Stade de France'";
	$sql .= "	WHEN stop = 473890 THEN 'Denfert-Rochereau'";
	$sql .= "	WHEN stop = 43607 THEN 'Laplace'";
	$sql .= "	ELSE 'Pas trouvé'";
	$sql .= "END AS Gare,";
...
if ($type == 'cons'){
	...
	$sql .= "	WHEN p.stop = 473364 THEN 'Aéroport CDG 2 TGV'";
	$sql .= "	WHEN p.stop = 43186 THEN 'Robinson'";
	$sql .= "	WHEN p.stop = 43086 THEN 'Orsay-Ville'";
	$sql .= "	WHEN p.stop = 43145 THEN 'La Plaine-Stade de France'";
	$sql .= "	WHEN p.stop = 473890 THEN 'Denfert-Rochereau'";
	$sql .= "	WHEN p.stop = 43607 THEN 'Laplace'";
	$sql .= "	ELSE 'Pas trouvé' ";
	$sql .= "END AS Gare, ";
	...
	$sql .= "	WHEN t.stop = 473364 THEN 'Aéroport CDG 2 TGV'";
	$sql .= "	WHEN t.stop = 43186 THEN 'Robinson'";
	$sql .= "	WHEN t.stop = 43086 THEN 'Orsay-Ville'";
	$sql .= "	WHEN t.stop = 43145 THEN 'La Plaine-Stade de France'";
	$sql .= "	WHEN t.stop = 473890 THEN 'Denfert-Rochereau'";
	$sql .= "	WHEN t.stop = 43607 THEN 'Laplace'";
	$sql .= "	ELSE 'Pas trouvé' ";
	$sql .= "END AS Gare, ";

...
?>
					...
					<p class="mb-4">
					Voici un autre site web qui permet d'avoir les informations comme sur les écrans en gare : <a href="https://monrer.fr/">monrer.fr</a>
					</p>
						...
						<div class="card-body">
							<div class="row no-gutters align-items-center">
                                 <div class="col mr-2">
									...
									<p class="mb-4">
										<ul> 
											Début d'exploitation des données prévisionelles : Affichage de l'horaire prévue dans les enregistrements des passages (Météo)										
										</ul>
									</p>
								</div>
							</div>
						...
						<div class="card-body">
							<div class="row no-gutters align-items-center">
                                 <div class="col mr-2">
									...
									<p class="mb-4">
										<ul> 
											<li>Rajout de la page météo du RER B pour Bourg-la-reine et Aulnay-Sous-Bois</li>
